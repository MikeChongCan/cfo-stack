...
description: Generate traceable HTML dashboards for company and household ledgers.
sidebar_position: 2
---
...
`/cfo-report-dashboard` is the design-forward reporting path for CFO Stack. It turns a valid `main.beancount` entrypoint into a static dashboard bundle:
